          ...
          <div className="px-4 py-6">
            ...
            <ul className="mt-6 space-y-1">
              <li>
                <a
                  href="#"
                  className="block rounded-lg px-4 py-2 text-sm font-medium text-text-700"
                >
                  General
                </a>
              </li>
              ...
              <li>
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                  <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-text-700 hover:bg-gray-100 hover:text-gray-700">
                  ...
                  <ul className="mt-2 space-y-1 px-4">
                    <li>
                      <a
                        href="#"
                        className="block rounded-lg px-4 py-2 text-sm font-medium text-text-700 hover:bg-gray-100 hover:text-gray-700"
                      >
                        Banned Users
                      </a>
                    </li>
                  ...
                  <ul className="mt-2 space-y-1 px-4">
                    ...
                    <li>
                      <form action="#">
                        <button
                          type="submit"
                          className="w-full rounded-lg px-4 py-2 text-sm font-medium text-text-700 [text-align:_inherit] hover:bg-gray-100 hover:text-gray-700"
                        >
                          Logout
                        </button>
                      </form>
            ...
            <a href="#" className="flex items-center gap-2 bg-primary-500 p-4">
              ...
              <div>
                <p className="text-xs">
                  ...
                  <span className="text-gray-300"> eric@frusciante.com </span>
                </p>
              </div>
            </a>
          </div>
