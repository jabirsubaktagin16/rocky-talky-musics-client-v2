...
export const Products = () => {
  ...
  // Fetch all products or category-wise products based on the category
  const { products: allProducts, loading: allProductsLoading } =
    useAllProducts();
  const { products: categoryProducts, loading: categoryProductsLoading } =
    useProductByCategory(category);

  // Use a useEffect hook to set products and loading state based on the category
  useEffect(() => {
    if (category) {
      // If category is present, use category-specific products
      setProducts(categoryProducts);
      setLoading(categoryProductsLoading);
    } else {
      // If no category, use all products
          ...
          {products?.data.length > 0 ? (
            ...
            <div className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
              <div className="w-full space-y-8 text-center">
                <div className="mb-8">
                  <h2 className="mt-2 text-3xl font-bold text-gray-600 dark:text-gray-100">
        ...
        <Modal show={openModal} onClose={() => setOpenModal(false)}>
          ...
          <Modal.Body>
            <Tabs aria-label="Tabs with underline" variant="fullWidth">
              <Tabs.Item active title="Brand" icon={HiUserCircle}>
                <div id="myTabContent">
                  <div
              ...
              <Tabs.Item title="Advanced Filters" icon={MdDashboard}>
                <div
                  className="space-y-4"
                  id="advanced-filters"
                  role="tabpanel"
          ...
          <Modal.Footer>
            <div className="flex items-center space-x-4 rounded-b dark:border-gray-600">
              <button
                type="submit"
